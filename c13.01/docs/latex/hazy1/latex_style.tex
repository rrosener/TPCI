...
See Section \ref{Hazy2-sec:SubroutineCdColm}
\cdSectionTitle{\refname{Hazy2-sec:SubroutineCdColm}} in Hazy 2.
\begin{verbatim}
See
Section \ref{Hazy3-sec:SubroutineCdColm}
\cdSectionTitle{\refname{Hazy2-sec:SubroutineCdColm}}
in Hazy 2.
\end{verbatim}

For this to work across all volumes of Hazy we must include the
package \cdRoutine{xr}
and we must list the filenames of all chapters of all three volumes in
\cdFilename{head\_info.tex} using the
\cdCommand{\\externaldocument} markup.
...
\begin{table}[h]
\centering
\caption{Macros defined in \cdFilename{macros.tex}}
\begin{tabular}{ l l l}
\hline
